...
lib.ssMetadata = [
		{name:"Traffic_DV360_Display_SPN_300x250_atlas_P_1", frames: [[0,0,600,500],[0,502,600,500]]},
		{name:"Traffic_DV360_Display_SPN_300x250_atlas_NP_1", frames: [[0,0,600,500],[0,502,600,500]]}
];
...
(lib._300x250AFRAME = function() {
	this.initialize(ss["Traffic_DV360_Display_SPN_300x250_atlas_P_1"]);
	this.gotoAndStop(0);
...
(lib._300x250A = function() {
	this.initialize(ss["Traffic_DV360_Display_SPN_300x250_atlas_NP_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// 300x250-CTA.ai
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#E8E8ED").s().p("");
	this.shape.setTransform(63.8,8.2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#E8E8ED").s().p("AgNAYQgGgDgDgHQgCgHAAgHQAAgHACgGQADgGAGgEQAGgDAHAAQAIAAAGADQAGAEADAGQACAGAAAHQAAAIgCAGQgDAGgGAEQgHAEgHAAQgHAAgGgEgAgJgMQgEAGAAAGQAAAIAEAFQADAFAGAAQAHAAADgFQADgFAAgIQAAgIgDgEQgDgFgHAAQgGAAgDAFg");
	this.shape_1.setTransform(58.775,8.2);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#E8E8ED").s().p("AASAbIABgpIgBAAIgOApIgJAAIgMgpIgBAAIABApIgLAAIAAg0IAQAAIAMAnIAAAAIANgnIAQAAIAAA0g");
	this.shape_2.setTransform(52.3,8.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#E8E8ED").s().p("AgOAbIAAg0IAdAAIAAAJIgSAAIAAAMIARAAIAAAIIgRAAIAAAOIASAAIAAAJg");
	this.shape_3.setTransform(46.825,8.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#E8E8ED").s().p("AgJAYQgFgDgDgHQgCgGAAgIQAAgHADgGQADgGAFgEQAGgDAHAAIAIABIAHACIgDAKIgGgDIgGgBQgGAAgDAFQgDAEAAAIQAAAJADAEQADAFAGAAIAGgBIAHgCIAAAJIgHADIgHABQgHAAgGgEg");
	this.shape_4.setTransform(42.325,8.2);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#E8E8ED").s().p("AAJAbIgWgoIAAAAIAAAoIgKAAIAAg0IAPAAIAWAmIgBgmIALAAIAAA0g");
	this.shape_5.setTransform(36.85,8.2);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#E8E8ED").s().p("AgOAbIAAg0IAdAAIAAAJIgSAAIAAAMIARAAIAAAIIgRAAIAAAOIASAAIAAAJg");
	this.shape_6.setTransform(31.875,8.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#E8E8ED").s().p("AASAbIAAgpIgOApIgJAAIgNgpIAAAAIAAAEIABAlIgKAAIAAg0IAPAAIAMAnIAAAAIANgnIAPAAIAAA0g");
	this.shape_7.setTransform(26.175,8.2);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#E8E8ED").s().p("AgNAYQgHgFgBgFQgDgGAAgIQAAgIADgFQABgFAHgFQAGgDAHAAQAHAAAHADQAFAEAEAGQACAFAAAIQAAAJgCAFQgDAHgGADQgGAEgIAAQgHAAgGgEgAgKgMQgCAEAAAIQAAAIACAFQAEAFAGAAQAHAAAEgFQADgFAAgIQAAgIgDgEQgEgFgHAAQgGAAgEAFg");
	this.shape_8.setTransform(19.7,8.2);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#E8E8ED").s().p("AgJAYQgFgEgCgGQgDgEAAgKQAAgIADgFQADgGAFgEQAHgDAFAAIAIABIAIACIgDAKIgGgDIgHgBQgFAAgDAFQgEAEABAIQAAAJACAEQAEAFAFAAIAHgBIAHgCIAAAJIgHADIgIABQgGAAgGgEg");
	this.shape_9.setTransform(14.6,8.2);
...
// stage content:
(lib.Traffic_DV360Display_SPN_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Traffic_DV360_Display_SPN_300x250_atlas_P_1.png", id:"Traffic_DV360_Display_SPN_300x250_atlas_P_1"},
		{src:"images/Traffic_DV360_Display_SPN_300x250_atlas_NP_1.jpg", id:"Traffic_DV360_Display_SPN_300x250_atlas_NP_1"}
	],
	preloads: []
};
