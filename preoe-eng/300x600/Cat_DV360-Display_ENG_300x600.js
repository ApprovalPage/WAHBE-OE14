...
lib.ssMetadata = [
		{name:"Cat_DV360_Display_ENG_300x600_atlas_P_1", frames: [[0,0,600,1200]]},
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib._300x600B();
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(150,255.6);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(71).to({_off:false},0).wait(71).to({scaleX:1.3,scaleY:1.3,x:149.95},3).to({scaleX:1,scaleY:1,x:150},5).wait(40));
	...
	// BKGD1
	this.instance_5 = new lib._300x600A();
...
p.nominalBounds = new cjs.Rectangle(150,300,234.39999999999998,300);
// library properties:
lib.properties = {
