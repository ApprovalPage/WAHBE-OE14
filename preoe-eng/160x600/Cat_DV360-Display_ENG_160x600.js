...
lib.ssMetadata = [
		{name:"Cat_DV360_Display_ENG_160x600_atlas_P_1", frames: [[0,0,320,1200],[322,0,320,1200]]},
		{name:"Cat_DV360_Display_ENG_160x600_atlas_NP_1", frames: [[0,0,320,1200],[322,0,320,1200]]}
];
...
(lib._160x600AFRAME = function() {
	this.initialize(ss["Cat_DV360_Display_ENG_160x600_atlas_P_1"]);
	this.gotoAndStop(0);
...
(lib._160x600A = function() {
	this.initialize(ss["Cat_DV360_Display_ENG_160x600_atlas_NP_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
// stage content:
(lib.Cat_DV360Display_ENG_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Cat_DV360_Display_ENG_160x600_atlas_P_1.png", id:"Cat_DV360_Display_ENG_160x600_atlas_P_1"},
		{src:"images/Cat_DV360_Display_ENG_160x600_atlas_NP_1.jpg", id:"Cat_DV360_Display_ENG_160x600_atlas_NP_1"}
	],
	preloads: []
};
