...
lib.ssMetadata = [
		{name:"Traffic_DV360_Display_ENG_300x600_atlas_P_1", frames: [[0,0,600,1200],[602,0,600,1200]]},
		{name:"Traffic_DV360_Display_ENG_300x600_atlas_NP_1", frames: [[0,0,600,1200],[602,0,600,1200]]}
];
...
(lib._300x600AFRAME = function() {
	this.initialize(ss["Traffic_DV360_Display_ENG_300x600_atlas_P_1"]);
	this.gotoAndStop(0);
...
(lib._300x600A = function() {
	this.initialize(ss["Traffic_DV360_Display_ENG_300x600_atlas_NP_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// 300x600-CTA.ai
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#E8E8ED").s().p("AgiAqIAAhTIAaAAQALAAAMAFQAKAEAFAKQAFAJAAANQAAAUgMALQgNALgUAAgAgQAcIAHAAQAZAAAAgcQAAgNgGgHQgGgGgLAAIgJAAg");
	this.shape.setTransform(118.6,13.15);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#E8E8ED").s().p("AgXAqIAAhTIAvAAIAAAPIgdAAIAAATIAbAAIAAANIgbAAIAAAWIAdAAIAAAOg");
	this.shape_1.setTransform(110.8,13.15);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#E8E8ED").s().p("AgIAqIAAhEIgXAAIAAgPIA/AAIAAAPIgXAAIAABEg");
	this.shape_2.setTransform(103.775,13.15);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#E8E8ED").s().p("AAOAqIgTggIgJAAIAAAgIgSAAIAAhTIAYAAQAQAAAIAHQAIAFAAAOQAAAGgCAEQgBADgFADIgHAEIAYAlgAgOgEIAFAAQAJAAADgCQADgDAAgGQAAgGgDgCQgDgDgKAAIgEAAg");
	this.shape_3.setTransform(96.85,13.15);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#E8E8ED").s().p("AAVAqIgGgUIgeAAIgFAUIgTAAIAdhTIAUAAIAfBTgAgCgPIgIAWIAVAAIgLgjg");
	this.shape_4.setTransform(88.25,13.15);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#E8E8ED").s().p("AgIAqIAAhEIgWAAIAAgPIA9AAIAAAPIgWAAIAABEg");
	this.shape_5.setTransform(81.45,13.15);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#E8E8ED").s().p("AgaAmIAAgRIAMAFQAGACAHAAQAGAAACgCQADgCAAgFQAAgCgCgDIgGgEIgOgIIgGgDIgFgHQgCgEAAgGQAAgMAHgGQAHgGANAAQAHAAAGABIAMAFIgGAOIgKgEIgJgBQgFAAgCACQgDADAAADQAAAFAEACIAWAMQAFADACAFQACAEAAAHQAAALgIAGQgIAHgNAAQgNAAgLgFg");
	this.shape_6.setTransform(74.675,13.175);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#E8E8ED").s().p("AgIAqIAAhEIgXAAIAAgPIA+AAIAAAPIgWAAIAABEg");
	this.shape_7.setTransform(64.65,13.15);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#E8E8ED").s().p("AgXAqIAAhTIAvAAIAAAPIgdAAIAAATIAbAAIAAANIgbAAIAAAWIAdAAIAAAOg");
	this.shape_8.setTransform(57.975,13.15);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#E8E8ED").s().p("AgXAgQgKgLAAgVQgBgMAGgKQAEgJALgGQAKgFANAAQAGAAAHABIALAEIgFAOIgJgDIgKgBQgJAAgEADQgFADgEAHQgDAGAAAIQAAAIADAHQACAHAFADQADADAIAAIALgBIAAgRIgPAAIAAgOIAgAAIAAAqIgNAEQgHABgJAAQgSAAgKgLg");
	this.shape_9.setTransform(49.95,13.175);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#E8E8ED").s().p("AgaAmIAAgRIAMAFQAGACAHAAQAGAAACgCQADgCAAgFQAAgDgCgCIgGgEIgOgIIgGgDQgEgEgBgDQgCgEAAgGQAAgMAHgGQAHgGANAAQAHAAAGABIAMAFIgGAOIgKgEIgKgBQgEAAgCACQgDACAAAEQAAAFAEACIAWAMQAFAEACAEQACAEAAAHQAAALgIAGQgIAHgOAAQgMAAgLgFg");
	this.shape_10.setTransform(39.275,13.175);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#E8E8ED").s().p("AgKAPIADgPIACgOIAPAAIABACIgKAbg");
	this.shape_11.setTransform(34.575,10.4);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#E8E8ED").s().p("AgIAqIAAhEIgXAAIAAgPIA/AAIAAAPIgXAAIAABEg");
	this.shape_12.setTransform(29.725,13.15);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#E8E8ED").s().p("AgXAqIAAhTIAvAAIAAAPIgdAAIAAATIAbAAIAAANIgbAAIAAAWIAdAAIAAAOg");
	this.shape_13.setTransform(23.075,13.15);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#E8E8ED").s().p("AgZAqIAAhTIASAAIAABFIAhAAIAAAOg");
	this.shape_14.setTransform(16.45,13.15);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#621F7B").s().p("AolCIQg1AAglgmQgmglAAg1IAAgPQAAg1AmglQAlgmA1AAIRMAAQA0AAAmAmQAlAlAAA1IAAAPQAAA1glAlQgmAmg0AAg");
	this.shape_15.setTransform(67.775,13.575);
...
p.nominalBounds = new cjs.Rectangle(0,0,135.6,27.2);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-28.75,-5.15,1,1,0,0,0,39,8.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA, new cjs.Rectangle(-67.7,-13.5,135.5,27.1), null);


// stage content:
(lib.Traffic_DV360Display_ENG_300x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Traffic_DV360_Display_ENG_300x600_atlas_P_1.png", id:"Traffic_DV360_Display_ENG_300x600_atlas_P_1"},
		{src:"images/Traffic_DV360_Display_ENG_300x600_atlas_NP_1.jpg", id:"Traffic_DV360_Display_ENG_300x600_atlas_NP_1"}
	],
	preloads: []
};
