...
lib.ssMetadata = [
		{name:"Traffic_DV360_Display_ENG_320x50_atlas_P_1", frames: [[0,0,640,100],[0,102,640,100]]},
		{name:"Traffic_DV360_Display_ENG_320x50_atlas_NP_1", frames: [[0,0,640,100]]}
];
...
(lib._320x50AFRAME = function() {
	this.initialize(ss["Traffic_DV360_Display_ENG_320x50_atlas_P_1"]);
	this.gotoAndStop(0);
...
(lib._320x50A = function() {
	this.initialize(ss["Traffic_DV360_Display_ENG_320x50_atlas_NP_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// 320x50-CTA.ai
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#E8E8ED").s().p("AgiAqIAAhTIAbAAQAKAAALAFQAKAEAGAKQAFAJAAANQAAAUgMALQgNALgUAAgAgQAcIAHAAQAZAAAAgcQABgNgHgHQgGgGgKAAIgKAAg");
	this.shape.setTransform(116.55,13.15);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#E8E8ED").s().p("AgXAqIAAhTIAvAAIAAAPIgeAAIAAATIAcAAIAAANIgcAAIAAAWIAeAAIAAAOg");
	this.shape_1.setTransform(108.75,13.15);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#E8E8ED").s().p("AgIAqIAAhEIgXAAIAAgPIA/AAIAAAPIgXAAIAABEg");
	this.shape_2.setTransform(101.725,13.15);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#E8E8ED").s().p("AAOAqIgTggIgKAAIAAAgIgSAAIAAhTIAZAAQAQAAAJAHQAHAFABAOQgBAGgCAEQgCADgDADIgIAEIAZAlgAgPgEIAGAAQAJAAACgCQAEgDABgGQgBgGgEgCQgCgDgJAAIgGAAg");
	this.shape_3.setTransform(94.8,13.15);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#E8E8ED").s().p("AAWAqIgHgUIgdAAIgGAUIgTAAIAdhTIAUAAIAfBTgAgCgPIgIAWIAVAAIgLgjg");
	this.shape_4.setTransform(86.2,13.15);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#E8E8ED").s().p("AgIAqIAAhEIgXAAIAAgPIA+AAIAAAPIgWAAIAABEg");
	this.shape_5.setTransform(79.4,13.15);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#E8E8ED").s().p("AgaAmIAAgRIAMAFQAGACAHAAQAGAAACgCQADgCAAgFQAAgCgCgDIgGgEIgHgEIgNgHIgFgHQgCgEAAgGQAAgMAHgGQAHgGANAAQAHAAAGABIAMAFIgGAOIgKgEIgJgBQgFAAgCACQgDADAAADQAAAFAEACIAWAMQAFADACAFQACAEAAAHQAAALgIAGQgIAHgNAAQgNAAgLgFg");
	this.shape_6.setTransform(72.625,13.175);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#E8E8ED").s().p("AgIAqIAAhEIgWAAIAAgPIA+AAIAAAPIgXAAIAABEg");
	this.shape_7.setTransform(62.6,13.15);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#E8E8ED").s().p("AgXAqIAAhTIAvAAIAAAPIgdAAIAAATIAbAAIAAANIgbAAIAAAWIAdAAIAAAOg");
	this.shape_8.setTransform(55.925,13.15);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#E8E8ED").s().p("AgXAgQgKgLAAgVQAAgMAFgKQAEgJAKgGQALgFANAAQAGAAAHABIAMAEIgGAOIgJgDIgKgBQgJAAgEADQgFADgEAHQgDAGAAAIQAAAIACAHQADAHAEADQAEADAIAAIALgBIAAgRIgPAAIAAgOIAhAAIAAAqIgOAEQgIABgIAAQgSAAgKgLg");
	this.shape_9.setTransform(47.9,13.175);
	...
	this.shape_10.setTransform(37.225,13.175);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#E8E8ED").s().p("AgKAPIADgPIACgOIAPAAIABACIgKAbg");
	this.shape_11.setTransform(32.525,10.4);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#E8E8ED").s().p("AgIAqIAAhEIgXAAIAAgPIA/AAIAAAPIgXAAIAABEg");
	this.shape_12.setTransform(27.675,13.15);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#E8E8ED").s().p("AgXAqIAAhTIAvAAIAAAPIgdAAIAAATIAbAAIAAANIgbAAIAAAWIAdAAIAAAOg");
	this.shape_13.setTransform(21.025,13.15);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#E8E8ED").s().p("AgZAqIAAhTIASAAIAABFIAhAAIAAAOg");
	this.shape_14.setTransform(14.4,13.15);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#621F7B").s().p("AoRCIQg1AAglgmQglglAAg1IAAgPQAAg1AlglQAlgmA1AAIQjAAQA1AAAlAmQAlAlAAA1IAAAPQAAA1glAlQglAmg1AAg");
	this.shape_15.setTransform(65.725,13.575);
...
p.nominalBounds = new cjs.Rectangle(0,0,131.5,27.2);
...
}).prototype = getMCSymbolPrototype(lib.CTA, new cjs.Rectangle(-62.7,-13.5,131.4,27.1), null);


// stage content:
(lib.Traffic_DV360Display_ENG_320x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Traffic_DV360_Display_ENG_320x50_atlas_P_1.png", id:"Traffic_DV360_Display_ENG_320x50_atlas_P_1"},
		{src:"images/Traffic_DV360_Display_ENG_320x50_atlas_NP_1.jpg", id:"Traffic_DV360_Display_ENG_320x50_atlas_NP_1"}
	],
	preloads: []
};
