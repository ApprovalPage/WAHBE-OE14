...
lib.ssMetadata = [
		{name:"Traffic_DV360_Display_ENG_300x250_atlas_P_1", frames: [[0,0,600,500],[0,502,600,500]]},
		{name:"Traffic_DV360_Display_ENG_300x250_atlas_NP_1", frames: [[0,0,600,500],[0,502,600,500]]}
];
...
(lib._300x250AFRAME = function() {
	this.initialize(ss["Traffic_DV360_Display_ENG_300x250_atlas_P_1"]);
	this.gotoAndStop(0);
...
(lib._300x250A = function() {
	this.initialize(ss["Traffic_DV360_Display_ENG_300x250_atlas_NP_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	this.shape_9.setTransform(32.175,8.175);
	...
	this.shape_15.setTransform(43.25,8.425);
...
p.nominalBounds = new cjs.Rectangle(0,0,86.5,16.9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-4.25,-0.05,1,1,0,0,0,39,8.4);
...
// stage content:
(lib.Traffic_DV360Display_ENG_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Traffic_DV360_Display_ENG_300x250_atlas_P_1.png", id:"Traffic_DV360_Display_ENG_300x250_atlas_P_1"},
		{src:"images/Traffic_DV360_Display_ENG_300x250_atlas_NP_1.jpg", id:"Traffic_DV360_Display_ENG_300x250_atlas_NP_1"}
	],
	preloads: []
};
