...
lib.ssMetadata = [
		{name:"Traffic_DV360_Display_ENG_728x90_atlas_P_1", frames: [[0,0,1456,180],[0,182,1456,180]]},
		{name:"Traffic_DV360_Display_ENG_728x90_atlas_NP_1", frames: [[0,0,1456,180],[0,182,1456,180]]}
];
...
(lib._728x90AFRAME = function() {
	this.initialize(ss["Traffic_DV360_Display_ENG_728x90_atlas_P_1"]);
	this.gotoAndStop(0);
...
(lib._728x90A = function() {
	this.initialize(ss["Traffic_DV360_Display_ENG_728x90_atlas_NP_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
// stage content:
(lib.Traffic_DV360Display_ENG_728x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Traffic_DV360_Display_ENG_728x90_atlas_P_1.png", id:"Traffic_DV360_Display_ENG_728x90_atlas_P_1"},
		{src:"images/Traffic_DV360_Display_ENG_728x90_atlas_NP_1.jpg", id:"Traffic_DV360_Display_ENG_728x90_atlas_NP_1"}
	],
	preloads: []
};
